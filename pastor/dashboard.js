...
function vsToggleExpand(btn) {
  ...
  if (expanded) {
    w.style.maxWidth = 'min(600px,92vw)';
    ...
    overlay.innerHTML = `
      <div style="background:#0d2142;min-height:100%;width:100%;padding:24px;box-sizing:border-box;">
        ...
        ${s.transcript ? `<div style="margin-top:20px;">
          ...
          <div id="vs-reading-area" style="width:100%;max-width:min(600px,92vw);margin:0 auto;transition:max-width 0.3s ease;overflow:hidden;">
